            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('management.process.create') }}" method="POST">
                            @csrf
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">عنوان فرایند</label>
                                    <input type="text" maxlength="50" name="process_title" class="form-control" id="exampleInputEmail1" placeholder="عنوان فرایند
">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">اولویت
                                    </label>
                                    <input type="number" name="process_order_id" class="form-control" min="1" max="10" id="exampleInputEmail1" placeholder="اولویت
